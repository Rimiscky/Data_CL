...
class CrossDashboardBuilder:
    ...
    def export_html(self, filename: str = "dashboard_cross_energy_meteo.html") -> Path:
        ...
        html_parts = [
            ...
            "              color: white; padding: 22px 40px; display:flex; align-items:center; gap:20px; }",
            "    .header h1 { font-size: 1.8em; }",
            "    .header p { opacity: 0.8; margin-top: 5px; }",
            "    .back-btn { background: rgba(255,255,255,.15); color: #fff; border: none;",
            "                border-radius: 8px; padding: 8px 16px; font-size: .85em; cursor: pointer;",
